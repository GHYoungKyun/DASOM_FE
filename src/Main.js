                    ...
                    <div className="gender_filter">
                        ...
                        <div className="dd-wrapper" onClick={toggling}>
                            ...
                            >
                                ...
                                <span className={`${genderSelected ? "selected" : ""}`}>
                                    {selectedOption}
                                </span>
                            </button>
                            {isOpen && (
                        ...
                        <div className="num-dropdown" onClick={numToggling}>
                            ...
                            >
                                ...
                                <span className={`${numSelected ? "selected" : ""}`}>
                                    {numSelectedOption}
                                </span>
                            </button>
                            {numIsOpen && (
                        ...
                        <div className="search">
                            <input value={keyword} onChange={(event) => setKeyword(event.target.value)} type="text" className="searchbar" placeholder="검색글을 입력해주세요"/>
